...
Текущий fuzz-набор включает 5 сценариев и 105 проверок: регистрацию, malformed JSON для mutating endpoints, защищенные бизнес-маршруты, ежедневные/import/shopping маршруты и отдельный adversarial-набор из 100 API request shapes.
